...
for model_name in [
    ...
    for xai_method in xai_methods + xai_methods_ms:
        ...
        config_name = f"{model_name.lower()}_{xai_method_str}"
        create_config_cluster(copy.deepcopy(base_config), config_name)
